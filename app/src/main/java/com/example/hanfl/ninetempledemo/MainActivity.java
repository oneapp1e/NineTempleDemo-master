...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(R.id.x_recycler_view2)
    RecyclerView xRecyclerView2;
    @BindView(R.id.x_recycler_view3)
    ...
    private int[] array = new int[]{0, 1, 2, 5, 8, 7, 6, 3};//顺时针旋转数组，按照这个数组的排列顺序来改变方块背景色表示正在抽奖
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xRecyclerView2.setLayoutManager(new GridLayoutManager(this, 3));
        xRecyclerView2.setAdapter(demoAdapter);

        xRecyclerView3.setLayoutManager(new GridLayoutManager(this, 3));
        xRecyclerView3.setAdapter(demoAdapter);
    ...
    private synchronized void refreshView() {
        try {
            while (isRun) {
                Thread.sleep(200);
                int m = count % 8;
                Log.d("refreshView---->", "m:" + m + " result:" + result);
                if (m == 0) {
    ...
    private static class MainHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            Log.d("MainHandler---->", "what:" + msg.what);
            if (msg.what == 1) {
            ...
            if (msg.what == 3) {
                ...
                activity.builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        //设置运行停止
                        activity.demoAdapter.setRun(false);
                        activity.isRun = true;
                        activity.result = 9;
                        activity.isResult = true;
                        activity.demoAdapter.notifyDataSetChanged();
                    }
                });
